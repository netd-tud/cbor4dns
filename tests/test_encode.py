...
QUERY_AAAA_CBOR = (
    b"\x84\x19\xd5\xcd\x19\x01 \x81kexample.org\x81\xd4\x82\x19\x04"
    b"\xd0\x81\x82\nH\x99!\te3\xa3f\xb5"
    if cbor4dns.encode.RR.encode_opts
    else b"\x84\x19\xd5\xcd\x19\x01 \x81kexample.org\x81W\x00\x00)\x04"
...
QUERY_A_CBOR = (
    b"\x84\x19pu\x19\x01 \x82kexample.org\x01\x81\xd4\x82\x19\x04\xd0"
    b"\x81\x82\nHt^l\x10\xa8F\x19\xa4"
    if cbor4dns.encode.RR.encode_opts
    else b"\x84\x19pu\x19\x01 \x82kexample.org\x01\x81W\x00\x00)\x04"
...
RESPONSE_AAAA_CBOR = (
    ...
    if cbor4dns.encode.RR.encode_opts
    else b"\x86\x19\xb5>\x19\x81\x80\x81kexample.org\x81\x82\x19YQP&\x06(\x00\x02 "
    b"\x00\x01\x02H\x18\x93%\xc8\x19F\x86\x84corg\x1a\x00\x01\xb1\xf0\x02vd0.or"
    b"g.afilias-nst.org\x84corg\x1a\x00\x01\xb1\xf0\x02vb0.org.afilias-nst.org\x84"
    b"corg\x1a\x00\x01\xb1\xf0\x02vb2.org.afilias-nst.org\x84corg\x1a\x00"
    b"\x01\xb1\xf0\x02wc0.org.afilias-nst.info\x84corg\x1a\x00\x01\xb1\xf0\x02w"
...
TEST_VECTOR = (
    ...
    pytest.param(
        ...
        if cbor4dns.encode.RR.encode_opts
        else b"\x85\x19\xb5>\x19\x81\x80\x81\x82\x19YQP&\x06(\x00\x02 \x00\x01\x02H\x18"
        b"\x93%\xc8\x19F\x86\x84corg\x1a\x00\x01\xb1\xf0\x02vd0.org.afilias-nst.org"
    ...
    pytest.param(
        ...
        None,
        True,
        b"\x82\x91\x1a\x00\x01\xb1\xf0corgu.org.afilias-nst.info\xd8\xd9q.org.afi"
        ...
        b"\x00\x00\x00\x00\x00\x00\x00\x00\x01\x83\xed\xe0\xef\xd4\x82\x19"
        b"\x10\x00\x81\x82\nX\x18\x16\x19\xc4\x7fn\xd6\xc4\xab\xef\xec\xe8yd5F\xd3{"
        b"\x9c\xb7\xd5a\xaa\xd9\xc2"
        if cbor4dns.encode.RR.encode_opts
    ...
    pytest.param(
        ...
        b"\x00\x00\x00\x00\x01\x83\xed\xe0\xef\xd4\x82\x19\x10\x00\x81\x82\nX\x18\x16"
